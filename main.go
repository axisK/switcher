...
var (
	...
	ircAddress     = flag.String("irc", "127.0.0.1:6667", "IRC Server Address")
...
func usage() {
	...
	fmt.Println("  --irc      <127.0.0.1:6667> SSH Server Address")
	fmt.Println("  --default  <127.0.0.1:8080> Default Server Address\n")

	fmt.Println("Examples:")
	fmt.Println("  To serve SSH(127.0.0.1:22), IRC(127.0.0.1:6667), and HTTP(127.0.0.1:8080) on port 80")
	fmt.Println("  $ switcher\n")

	fmt.Println("  To serve SSH(127.0.0.1:2222), IRC(127.0.0.1:6668), and HTTPS(127.0.0.1:443) on port 443")
	fmt.Println("  $ switcher --listen :443 --ssh 127.0.0.1:2222 --irc 127.0.0.1:6668 --default 127.0.0.1:443")
}
